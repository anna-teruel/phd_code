...
def initialize(Y_fm_chk,
    ...
    Returns:
        None. The function saves the results to the disk.
    """
    ...
    # 2. Initializing seeds from max projection
    print('Initializing seeds')
    seeds = seeds_init(Y_fm_chk, **param_seeds_init)

    # 3. Refining seeds with Peack-to-Noise Ratio (PNR)
